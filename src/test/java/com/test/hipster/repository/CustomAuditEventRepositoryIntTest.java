package com.test.hipster.repository;

import com.test.hipster.TestHipsterApp;
import com.test.hipster.config.Constants;
import com.test.hipster.config.audit.AuditEventConverter;
import com.test.hipster.domain.PersistentAuditEvent;
...
import static com.test.hipster.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
